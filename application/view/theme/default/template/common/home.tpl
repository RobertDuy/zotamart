...
<div class="products_section">
	...
	<div class="container">
		...
		<div class="categories">
				...
				<section class="category" id="category_0">
					...
					<ul class="product_wrap">
						...
						<li>
							<a href="product/fruit-fritter-of-the-day" >
								<div class="thumb_wrap">
						...
						<li>
							<a href="product/21" >
								<div class="thumb_wrap">
									<img src="<?php echo STATIC_FILE_PATH; ?>/uploads/_0015_birthday_small.png">
								</div>
								<div class="menu_item_controls">
									<div class="meta">
						...
						<li>
							...
							<a href="product/chocolatepeanut-butter-bismarck" >
								<div class="thumb_wrap">
						...
						<li>
							<a href="product/blackberry-cheesecake" >
								<div class="thumb_wrap">
				...
				<section class="category" id="category_4">
					<h1>Coffee</h1>
					<ul class="product_wrap">
						<li>
							<a href="product/38">
								<div class="thumb_wrap">
									<img src="<?php echo STATIC_FILE_PATH; ?>/images/JoeToGo_small.png"/>
								</div>
								<div class="menu_item_controls">
									<div class="meta">
										<h4>Joe-To-Go</h4>
						...
						<li>
							<a href="cafe_drinks.php">
								<div class="thumb_wrap">
									<img src="<?php echo STATIC_FILE_PATH; ?>/images/coffee_small.png">
								</div>
								<div class="menu_item_controls">
									<div class="meta">
										<h4>Cafe Drinks</h4>
